...
public class MySQLHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "hihihihi.db";
    ...
    public void insertData() {
        ...
        add(new GiaoDich(0, "Thuê nhà", "20/03/2023", false, "Liêm", 20000000));
        add(new GiaoDich(0, "Lương", "20/01/2023", true, "Duy", 10000000));
        add(new GiaoDich(0, "Lương", "20/02/2023", true, "Hiếu", 50000000));
    }
    ...
    public void update(GiaoDich giaoDich)
    {
        ...
        db.update(TABLE_NAME, values, COLUMN_ID + " = ?", new String[]{String.valueOf(giaoDich.getMaGiaoDich())});
        db.close();
    }
}
